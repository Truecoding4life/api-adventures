...
const handleFailLogin = (message) => {
    ...
    wrapper.innerHTML = `
        <div class="alert alert-danger alert-dismissible login-alert-danger animate__animated animate__bounceIn" role="alert">
...
const handleSuccess = (message) => {
    const wrapper = document.createElement('div');
    wrapper.innerHTML = `
        <div class="alert alert-success alert-dismissible login-alert-success animate__animated animate__bounceIn" role="alert">
            <div class="d-flex align-item-center">
